 ...
 * @author Jason
 */
public class DivisionLargeNumbers {
    ...
    public ListaCircularDE divisionLargeNumbers(ListaCircularDE lista1, ListaCircularDE lista2, ListaCircularDE listaCociente, boolean signo) {
        ...
        if(signo == true){
            archivo.escribirArchivo("ResultadoDivision.txt", "-");
            System.out.print("[-]");
        }
        ...
        if (lista1.encontrarTamañoDeTodaLaLista(lista1) > lista2.encontrarTamañoDeTodaLaLista(lista2)) {
            ...
            do {
                ...
                if (stop == false) {
                    ...
                    archivo.escribirArchivo("ResultadoDivision.txt", Integer.toString(numeroCorrecto));
        ...
        if (lista1.encontrarTamañoDeTodaLaLista(lista1) < lista2.encontrarTamañoDeTodaLaLista(lista2)) {
            ...
            archivo.escribirArchivo("ResultadoDivision.txt", "0");
